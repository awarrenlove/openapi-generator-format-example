...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.root_post  # this is an instance of the class Endpoint
        api_instance.root_post()  # this invokes api_instance.root_post.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.root_post.callable or self.callable in this class
